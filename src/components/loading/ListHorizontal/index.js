      ...
      <div className="overflow-hidden whitespace-nowrap pb-8 -mx-2">
        {[1, 2, 3].map((index) => {
          return (
            <div
              key={index}
              className="bg-white rounded-2xl pb-2 w-80 inline-block mx-2"
            >
              <div className="h-44 w-full rounded-t-2xl bg-gray-400" />
              <div className="px-4 py-2 whitespace-normal">
                <div className="mb-1 bg-gray-400 w-3/4 h-4 my-2 rounded-2xl" />
                <div className="bg-gray-400 h-5 my-2 rounded-2xl" />
                <div className="h-3 mt-2 mb-1 rounded-2xl bg-gray-400" />
                <div className="h-3 mb-2 mt-1 rounded-2xl bg-gray-400" />
